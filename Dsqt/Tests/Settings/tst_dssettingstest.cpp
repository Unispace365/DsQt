...
void DSSettingsTest::get_QVariantList_shouldReturnAValidQVariantList_data()
{
    ...
    QVariantList simple= {QVariant(10),QVariant("string"),QVariant(10.5),QVariantMap({{"r",QVariant(1)},{"g",QVariant(0)},{"b",QVariant(0)},{"a",QVariant(1)}})};
    QVariantList header= {QVariantMap({{"a",QVariant("first first")},{"b",QVariant("first second")}}),QVariantMap({{"a",QVariant("second first")},{"b",QVariant("second second")}})};

    QTest::newRow("value_raw")<<"list"<<simple;
    QTest::newRow("value_wo_meta")<<"list_wo_meta"<<simple;
    //QTest::newRow("value")<<"list_w_meta"<<simple;
    QTest::newRow("header")<<"header"<<header;
