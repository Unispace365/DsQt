#ifndef DSQMLTOUCHENGINEFLOATBUFFERINPUT_H
#define DSQMLTOUCHENGINEFLOATBUFFERINPUT_H
...
/**
 * DsQmlTouchEngineFloatBufferInput - QML component for setting float buffer values on TouchEngine links
 ...
 * }
 */
class DsQmlTouchEngineFloatBufferInput : public DsQmlTouchEngineInputBase
{
    Q_OBJECT
    QML_NAMED_ELEMENT(DsTouchEngineFloatBufferInput)
...
public:
    explicit DsQmlTouchEngineFloatBufferInput(QObject *parent = nullptr);
    ~DsQmlTouchEngineFloatBufferInput() override;
...
#endif // DSQMLTOUCHENGINEFLOATBUFFERINPUT_H
