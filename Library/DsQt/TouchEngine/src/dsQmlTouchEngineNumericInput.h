#ifndef DSQMLTOUCHENGINENUMERICINPUT_H
#define DSQMLTOUCHENGINENUMERICINPUT_H
...
/**
 * DsQmlTouchEngineNumericInput - QML component for setting numeric values on TouchEngine links
 * Supports int, float/double, and boolean values
 *
 * Example usage in QML:
 * DsTouchEngineNumericInput {
 *     instanceId: myInstance.instanceIdString
 *     linkName: "speed"
 *     value: 0.5
 *     inputType: DsTouchEngineNumericInput.Float
 * }
 */
class DsQmlTouchEngineNumericInput : public DsQmlTouchEngineInputBase
{
    Q_OBJECT
    QML_NAMED_ELEMENT(DsTouchEngineNumericInput)
...
public:
    explicit DsQmlTouchEngineNumericInput(QObject *parent = nullptr);
    ~DsQmlTouchEngineNumericInput() override;
...
#endif // DSQMLTOUCHENGINENUMERICINPUT_H
