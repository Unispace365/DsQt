...
KeyboardStyle {
    ...
    property Timer inputLocaleIndicatorHighlightTimer: Timer {
        interval: 1000
        onTriggered: currentStyle.inputLocaleIndicatorOpacity = 0.5
    }
    ...
    keyboardDesignWidth: 1440
    keyboardDesignHeight: 800
    keyboardRelativeLeftMargin: 122 / keyboardDesignWidth
    keyboardRelativeRightMargin: 122 / keyboardDesignWidth
    keyboardRelativeTopMargin: 152 / keyboardDesignHeight
    keyboardRelativeBottomMargin: 101 / keyboardDesignHeight

    keyboardBackground: Rectangle {
        color: keyboardBackgroundColor
        border {
            width: 1
            color: keyboardBackgroundBorderColor
        }
        radius: 74 * scaleHint
        opacity: 0.8
    }
