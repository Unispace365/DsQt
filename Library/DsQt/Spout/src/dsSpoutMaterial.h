...
/**
 * Material for rendering Spout textures with RHI
 */
class DsSpoutMaterial : public QSGMaterial
{
public:
    DsSpoutMaterial();
...
/**
 * RHI-based shader for Spout material
 */
class DsSpoutMaterialShader : public QSGMaterialShader
{
public:
    DsSpoutMaterialShader();
