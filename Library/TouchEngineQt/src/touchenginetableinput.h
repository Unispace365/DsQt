#ifndef TOUCHENGINETABLEINPUT_H
#define TOUCHENGINETABLEINPUT_H
...
/**
 * TouchEngineTableInput - QML component for setting table/tabular data on TouchEngine links
 * 
 * Example usage in QML:
 * TouchEngineTableInput {
 ...
 * }
 */
class TouchEngineTableInput : public TouchEngineInputBase
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TouchEngineTableInput)
...
public:
    explicit TouchEngineTableInput(QObject *parent = nullptr);
    ~TouchEngineTableInput() override;
