#ifndef DSQMLTOUCHENGINEINPUTBASE_H
#define DSQMLTOUCHENGINEINPUTBASE_H
 ...
 */
class DsQmlTouchEngineInputBase : public QObject
{
    Q_OBJECT
    QML_NAMED_ELEMENT(DsTouchEngineInputBase)
    QML_UNCREATABLE("DsTouchEngineInputBase is an abstract base class")
...
public:
    explicit DsQmlTouchEngineInputBase(QObject *parent = nullptr);
    virtual ~DsQmlTouchEngineInputBase();
...
#endif // DSQMLTOUCHENGINEINPUTBASE_H
