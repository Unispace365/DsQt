...
class DsQmlPlaylist : public QObject {
    ...
    Q_PROPERTY(DsQmlContentModel* model READ model NOTIFY modelChanged)
  ...
  public:
    ...
    DsQmlContentModel* model() const { return m_model; }
  ...
  private:
    ...
    DsQmlContentModel*           m_model     = nullptr;
    DsQmlEvent*                  m_event     = nullptr;
    QTimer*                      m_timer     = nullptr;
    dsqt::model::ContentModelRef m_playlist_model;
